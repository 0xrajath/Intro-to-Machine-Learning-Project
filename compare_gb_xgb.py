...
N_MODELS = 6
model_names = ['Gradient Boosting (10)', 'XGBoost (10)', 'Gradient Boosting (20)', 'XGBoost (20)', 'Gradient Boosting (40)', 'XGBoost (40)', ]
models = [
          ...
          GradientBoostingClassifier(random_state=1, max_depth=10, n_estimators=100, learning_rate=1),
          xgb.XGBClassifier(random_state=1, max_depth=10, n_estimators=100, learning_rate=1)
]
accuracy_train = []
accuracy_test = []
train_time = []
